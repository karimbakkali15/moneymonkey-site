      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-sans text-lg text-muted-foreground max-w-2xl mx-auto text-pretty leading-relaxed">
            Powerful tools behind a polished interface — the same{" "}
            <span className="text-[#e0c78c] font-medium">premium</span> feel you expect from a top-tier finance app.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group bg-card border border-white/[0.08] rounded-2xl p-6 hover:border-[#3373fa]/40 hover:shadow-[0_0_0_1px_rgba(224,199,140,0.12)] transition-all duration-300 shadow-sm shadow-black/20"
            >
              <div className="w-12 h-12 bg-[#3373fa]/12 rounded-xl flex items-center justify-center mb-4 ring-1 ring-[#e0c78c]/10 group-hover:bg-[#3373fa]/18 transition-colors">
                <feature.icon className="w-6 h-6 text-[#7a9eff]" />
              </div>
              <h3 className="font-serif text-lg font-semibold text-foreground mb-2 tracking-tight">{feature.title}</h3>
