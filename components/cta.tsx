    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-card border border-white/[0.08] rounded-3xl p-12 relative overflow-hidden shadow-xl shadow-black/30">
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#e0c78c] opacity-[0.05] rounded-full blur-[80px]" />
          ...
          <div className="relative">
            ...
            <p className="font-sans text-lg text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty leading-relaxed">
              Download Meridian and run your finances with{" "}
              <span className="text-[#e0c78c] font-medium">clarity</span> — tracking, saving, and AI that fits a{" "}
              <span className="text-[#e0c78c] font-medium">premium</span> workflow.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="https://apps.apple.com"
                className="font-sans inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#2556d8] to-[#3373fa] text-white px-8 py-4 rounded-xl font-semibold text-[15px] hover:opacity-95 transition-opacity shadow-lg shadow-[#3373fa]/25 ring-1 ring-[#e0c78c]/20"
              >
            ...
            <p className="font-sans text-sm text-muted-foreground mt-6">
              Free to download. No card required to try core features.
            </p>
          </div>
        </div>
      </div>
